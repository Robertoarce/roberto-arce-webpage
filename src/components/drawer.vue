<template>
  <div class="absolute left-0 z-20">
    ...
    <button @click="toggleDrawer" class="absolute left-0 mt-16 sm:mt-20 lg:mt-24 bg-blue-500 hover:bg-green-700 text-white 
      shadow-xl
      font-bold py-1 px-2 sm:py-2 sm:px-3 lg:py-4 lg:px-5 rounded-t-full transform rotate-90 -translate-y-1/2 text-xs sm:text-sm">
    Click Here
    </button>
    ...
    <transition name="slide">
      <div v-if="isDrawerOpen" class="fixed inset-y-0 left-0 z-50 h-full w-56 sm:w-64 p-2 sm:p-4 bg-gray-200 dark:bg-gray-800 transform">

        <!-- Close button -->
        <button @click="toggleDrawer"
          class="mb-2 sm:mb-4 mt-3 sm:mt-5 ml-4 sm:ml-10 px-3 sm:px-5 py-1 bg-slate-700 hover:bg-red-500 text-gray-100 font-bold rounded-full text-xs sm:text-sm">
          Close
        </button>
        ...
        <div class="text-white ">
          ...
          <div class="py-2 sm:py-4 overflow-y-auto">
            <ul class="space-y-1 sm:space-y-2 font-medium">
 
              
              <!-- Timeline -->
              <li>
                <a href="#"
                  class="flex items-center p-1 sm:p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                  @click.prevent="navigateTo('/timeline')">

                  <div class="relative left-[3px] sm:left-[5px] inline-block">
                    <svg
                      class="absolute top-[-6px] sm:top-[-8px] left-[-8px] sm:left-[-10px] z-[-1] flex-shrink-0 w-4 h-4 sm:w-5 sm:h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                    ...
                    <svg
                      class="relative right-[1px] sm:right-[2px] z-[1] w-4 h-4 sm:w-6 sm:h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                      aria-hidden="true" fill="currentColor" viewBox="0 0 14 18">
                      <path
                        d="M7 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9Zm2 1H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Z" />

                    </svg>
                  </div>
                  <span class="ml-2 sm:ml-3 text-xs sm:text-sm"> Time Line - CV </span>
                </a>
              </li>
              ...
              <div>
                ...
                <button @click="toggleDropdown"
                  class="text-white bg-green-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs sm:text-sm pl-3 sm:pl-5 pr-4 sm:pr-8 py-1.5 sm:py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  type="button">

                  <svg class="w-4 h-4 sm:w-6 sm:h-6 pr-2 sm:pr-3 text-gray-800 dark:text-white" aria-hidden="true"
                  ...
                  Visual ART
                  <svg class="w-2 h-2 sm:w-2.5 sm:h-2.5 ml-1 sm:ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 10 6">
                ...
                <div v-if="dropdownVisible"
                  class="z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-40 sm:w-44 dark:bg-gray-700">

                  <ul class="py-1 sm:py-2 text-xs sm:text-sm text-gray-700 dark:text-gray-200">
                      <!-- bug cube -->
                      <li>
                      <a href="#"
                        class="flex items-center p-1 sm:p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-500 group"
                        @click.prevent="navigateTo('/art/cube')">
                        <svg
                          class="flex-shrink-0 w-4 h-4 sm:w-5 sm:h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        ...
                        <span class="ml-2 sm:ml-3 text-xs sm:text-sm"> 3D - Cube </span>
                      </a>
                    </li>
                      <!-- gravitas -->
                    <li>
                      <a href="#"
                        class="flex items-center p-1 sm:p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-900 dark:hover:bg-gray-500 group"
                         @click.prevent="navigateTo('/art/coliders')">

                        <svg class="flex-shrink-0 w-4 h-4 sm:w-5 sm:h-5 text-gray-500 transition duration-75 dark:text-gray-400
                        ...
                        <span class="ml-2 sm:ml-3 text-xs sm:text-sm"> Gravitas </span>
                      </a>
                    </li>
                    ...
                    <li>
                      <a href="#"
                        ...
                        <span class="ml-2 sm:ml-3 text-xs sm:text-sm"> The Network </span>
                      </a>
                    </li>
                    <!-- Galaxy -->
                    <li>
                      <a href="#"
                        ...
                        <span class="ml-2 sm:ml-3 text-xs sm:text-sm"> Galaxy </span>
                      </a>
                    </li>
              ...
              <!-- --Linear Regression-- (Hidden on mobile) -->
              ...
              <!-- --Dynamic Graphs-- (Hidden on mobile) -->
              <li class="hidden md:block">
                <a href="#"
                  class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
...
<style scoped>
/* Custom transition classes for the slide effect */
.slide-enter-active,
.slide-leave-active {
